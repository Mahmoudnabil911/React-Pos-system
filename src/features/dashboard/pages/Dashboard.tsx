...
const TOP_PRODUCTS = [
  ...
  {
    name: "Tide Liquid Detergent 92oz",
    category: "Household",
    sold: 187,
    revenue: 2242.13,
    color: "#FF6F00",
  ...
  {
    name: "Starbucks Pike Place K-Cups",
    category: "Beverages",
    sold: 165,
    revenue: 1648.35,
    color: "#00704A",
    ...
    datasets: [
      {
        ...
        data: [
          18500, 22300, 19800, 24100, 27600, 25400, 29800, 32100, 28700, 35200,
          31800, 45231,
        ],
      ...
      },
      {
        ...
        data: [
          15200, 18100, 16900, 20400, 23200, 21800, 25100, 27300, 24600, 29800,
          26400, 38100,
        ],
  ...
  const chartOptions = {
    ...
    scales: {
      ...
      y: {
        ...
        ticks: {
          font: { size: 12 },
          callback: (v: unknown) => "$" + (Number(v) / 1000).toFixed(1) + "k",
        },
      },
    },
  };
                    ...
                    >
                      ...
                      <td style={{ padding: "0.875rem 1.25rem" }}>
                        <span className={getStatusBadge(sale.status)}>
                          ...
                          />
                          {t(`sales.${sale.status.toLowerCase()}`) ||
                            sale.status}
                        </span>
                      </td>
                      <td
