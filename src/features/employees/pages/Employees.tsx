  ...
  const columns = [
    {
      ...
      render: (row: (typeof MOCK_EMPLOYEES)[0]) => (
    ...
    },
    {
      ...
      label: t("common.role"),
      render: (row: (typeof MOCK_EMPLOYEES)[0]) => (
        <span className="badge badge-teal">{row.role}</span>
      ),
    },
    ...
    { key: "phone", label: t("common.phone") },
    {
      ...
      render: (row: (typeof MOCK_EMPLOYEES)[0]) => (
        <span className={statusBadgeClass(row.status)}>
          {t(`common.${row.status.toLowerCase()}`) || row.status}
        </span>
      ),
    },
  ...
  return (
    <div>
      ...
      <Modal
        ...
        title={
          editingItem ? t("employees.editEmployee") : t("employees.addEmployee")
        }
        footer={
